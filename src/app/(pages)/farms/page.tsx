    ...
    <>
      ...
      <div className="w-full sm:w-3/5 md:w-4/5 lg:w-3/5 xl:w-1/2 mx-auto px-2">
        ...
        <Title
          order={4}
          lts="5px"
          className="text-white uppercase text-center my-5"
        >
        ...
        <Title
          order={4}
          lts="5px"
          className="text-white uppercase text-center mt-10"
        >
          you are next
        </Title>
        <Group className="flex items-center justify-center my-10">
          <Image
            ...
            width={150}
            src={oneInchLogo}
            sizes="(max-width: 576px) 75px, (max-width: 768px) 100px, (max-width: 1200px) 150px, 150px"
            alt="1Inch Logo"
          ></Image>
          <Image
            className="mx-4"
