...
const CountDown: React.FC<CountDownProps> = ({ targetDate }) => {
    ...
    return (
        <Group className='timer-grid text-white text-center w-full mx-auto' >

            <Paper className='grid-item bg-vampire-light px-4 py-2 md:px-11 md:py-6 rounded' shadow="xs" radius="md" >
            ...
            <Paper className='grid-item bg-vampire-light px-4 py-2 md:px-10 md:py-6 rounded' shadow="xs" radius="md" >
            ...
            <span className='colon mx-0 md:mx-2'>:</span>
            <Paper className='grid-item bg-vampire-light px-4 py-2 md:px-9 md:py-6 rounded' shadow="xs" radius="md">
