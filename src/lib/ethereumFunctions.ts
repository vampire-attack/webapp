...
import * as chains from "../data/constants/chains";
import COINS from "../data/constants/coins";

import ROUTER from "../data/build/UniswapV2Router02.json";
...
export function getRouter(address: string, signer: any) {
    return new Contract(address, ROUTER.abi, signer);
}

export async function checkNetwork(provider: any) {
...
export function getWeth(address: string, signer: any) {
    return new Contract(address, ERC20.abi, signer);
}

export function getFactory(address: string, signer: any) {
...
export function doesTokenExist(address: string, signer: any) {
    try {
        return new Contract(address, ERC20.abi, signer);
    } catch (err) {
        return false;
...
export async function swapTokens(
    ...
    const deadline = ethers.toBigInt(time)
...
export async function fetchReserves(address1: string, address2: string, pair: any, signer: any) {
    try {
